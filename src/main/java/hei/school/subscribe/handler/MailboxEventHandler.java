package hei.school.subscribe.handler;

import static hei.school.subscribe.concurrency.ThreadRenamer.renameWorkerThread;
...
import hei.school.subscribe.PojaApplication;
import hei.school.subscribe.PojaGenerated;
import hei.school.subscribe.endpoint.EndpointConf;
import hei.school.subscribe.endpoint.event.EventConf;
import hei.school.subscribe.endpoint.event.consumer.EventConsumer;
import hei.school.subscribe.endpoint.event.consumer.model.ConsumableEvent;
import hei.school.subscribe.endpoint.event.consumer.model.ConsumableEventTyper;
