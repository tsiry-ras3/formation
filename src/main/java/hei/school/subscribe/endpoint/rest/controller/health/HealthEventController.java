package hei.school.subscribe.endpoint.rest.controller.health;

import static hei.school.subscribe.endpoint.rest.controller.health.PingController.KO;
import static hei.school.subscribe.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import hei.school.subscribe.PojaGenerated;
import hei.school.subscribe.endpoint.event.EventProducer;
import hei.school.subscribe.endpoint.event.model.DurablyFallibleUuidCreated1;
import hei.school.subscribe.endpoint.event.model.UuidCreated;
import hei.school.subscribe.repository.DummyUuidRepository;
import hei.school.subscribe.repository.model.DummyUuid;
