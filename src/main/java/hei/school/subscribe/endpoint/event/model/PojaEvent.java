package hei.school.subscribe.endpoint.event.model;

import static hei.school.subscribe.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.school.subscribe.PojaGenerated;
import hei.school.subscribe.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    return "hei.school.subscribe.event1";
  }
}
