...
import hei.school.subscribe.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("hei.school.subscribe.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "hei.school.subscribe.service.event."
